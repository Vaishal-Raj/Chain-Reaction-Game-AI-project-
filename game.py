...
FUNCS = {
	...
	'alphabeta':minimax.alpha_beta,
	'minmax':minimax.minmax
}
...
def main():
	global m,n, surface
	FUNC = FUNCS['minimax']
	if len(sys.argv) >= 2 and sys.argv[1] in ('minimax','alphabeta','minmax'):
